# MAAD-2-CALIB — Especificación Técnica

Especificación técnica del módulo de calibración y validación para SMA v0.4. Documentación para desarrolladores.
...
- Alineación académica: [`specs/ACADEMIC_ALIGNMENT.md`](ACADEMIC_ALIGNMENT.md)
