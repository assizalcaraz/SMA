# Documentación de Parámetros — Sistema de Partículas

Documentación completa de todos los parámetros ajustables en la aplicación de partículas (App A - openFrameworks).
